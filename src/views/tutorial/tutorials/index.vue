<template>
  <app-view>
    ...
    <app-footer>
      <router-link to="/provide-address">
        <ae-button face="round" fill="primary" shadow>Done, start migration</ae-button>
      </router-link>
    </app-footer>
  </app-view>
</template>
          ...
          steps: [
            {
              ...
              buttons: [
                {
                  img: require('@/assets/graphics/apple-store.svg'),
                  link: ''
                },
                {
                  img: require('@/assets/graphics/google-play.svg'),
                  link: ''
                }
              ]
            }
